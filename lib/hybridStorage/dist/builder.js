...
exports.RemoteStorageHelper = exports.StorageHelper = exports.localStorageOrigin = exports.webStorageOrigin = exports.storagePrefixer = exports.storageEncoder = exports.backupUploads = exports.dummyRemoteDecorator = exports.cacheSyncPromise = exports.remoteStage = void 0;
...
exports.backupUploads = backupUploads;
...
var StorageHelper = /** @class */ (function () {
    ...
    StorageHelper.decorator = function (parent) {
        return new StorageHelper(parent);
    };
    Object.defineProperty(StorageHelper.prototype, "size", {
        // 소속 키의 수
        get: function () {
    ...
    // 키 삭제
    StorageHelper.prototype.delete = function () {
        var e_5, _a;
        var _b;
        var keys = [];
    ...
    StorageHelper.prototype.forEach = function (callbackfn, thisArg) {
        var e_6, _a;
        try {
    ...
    // 특정 키의 값 불러오기
    StorageHelper.prototype.get = function (key) {
        var _a;
        if (key)
    ...
    StorageHelper.prototype.getAll = function (keys) {
        var e_7, _a, e_8, _b;
        var _c;
        var values = {};
        if (!keys)
    ...
    // 특정 키의 존재여부 확인
    StorageHelper.prototype.has = function (key) {
        return this.keys().has(key);
    };
    StorageHelper.prototype.hasAll = function () {
        var e_9, _a;
        var keys = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            keys[_i] = arguments[_i];
    ...
    StorageHelper.prototype.hasSome = function () {
        var e_10, _a;
        var keys = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            keys[_i] = arguments[_i];
    ...
    StorageHelper.prototype.set = function (keys, value) {
        var e_11, _a;
        var _b;
    ...
    StorageHelper.prototype.keys = function () {
        if (this[MEMBERS])
            return this[MEMBERS];
        return this[PARENT].keys();
    };
    StorageHelper.prototype.decorate = function () {
        var decorators = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            decorators[_i] = arguments[_i];
        }
        return new (StorageHelper.bind.apply(StorageHelper, __spreadArray([void 0, this], __read(decorators), false)))();
    };
    return StorageHelper;
}());
exports.StorageHelper = StorageHelper;
var RemoteStorageHelper = /** @class */ (function (_super) {
    __extends(RemoteStorageHelper, _super);
    function RemoteStorageHelper(parent) {
        var decorators = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            decorators[_i - 1] = arguments[_i];
        }
        return _super.apply(this, __spreadArray([parent], __read(decorators), false)) || this;
    }
    RemoteStorageHelper.decorator = function (parent) {
        return new RemoteStorageHelper(parent);
    };
    // 클라우드 저장소에서 최신 데이터 불러오기
    RemoteStorageHelper.prototype.pull = function () {
        return Promise.resolve(this[PARENT].pull());
    };
    // 클라우드 저장소에 수정사항 저장하기
    RemoteStorageHelper.prototype.push = function () {
        return Promise.resolve(this[PARENT].push());
    };
    RemoteStorageHelper.prototype.sync = function () {
        return Promise.all([this.pull(), this.push()]);
    };
    RemoteStorageHelper.prototype.decorate = function () {
        var decorators = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            decorators[_i] = arguments[_i];
        }
        return new (RemoteStorageHelper.bind.apply(RemoteStorageHelper, __spreadArray([void 0, this], __read(decorators), false)))();
    };
    return RemoteStorageHelper;
}(StorageHelper));
exports.RemoteStorageHelper = RemoteStorageHelper;
