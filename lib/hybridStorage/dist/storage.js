...
module.exports = mw.user.isAnon()
    ? new builder_1.HybridStorage((0, builder_1.webStorageOrigin)(localStorage), builder_1.dummyRemoteDecorator)
    : new builder_1.HybridStorage((0, builder_1.remoteStage)({
        //@ts-ignore 강제로 덮어쓰기
