...
exports.SyncableStorage = exports.localOrigin = exports.StorageOrigin = exports.propOptions = exports.IS_MY_KEY = exports.DECODE_KEY = exports.ENCODE_KEY = exports.NAMESPACE = exports.GET_MEMBERS = exports.MEMBERS = exports.STORAGE = void 0;
...
var SyncableStorage = /** @class */ (function () {
    function SyncableStorage(parent, namespace, keyEncoder) {
        ...
        Object.defineProperties(this, (_b = {
            ...
            _b[exports.NAMESPACE] = exports.propOptions,
            _b));
    }
    Object.defineProperty(SyncableStorage.prototype, "unsaved", {
        // 저장이 완료되지 않았는지 여부
        get: function () {
            return this[exports.STORAGE].unsaved;
        },
        enumerable: false,
        configurable: true
    });
    ...
    SyncableStorage.prototype[(_a = exports.MEMBERS, exports.ENCODE_KEY)] = function (key) {
        if (!this.encodeKey)
            return this[exports.NAMESPACE] + key;
    ...
    SyncableStorage.prototype[exports.DECODE_KEY] = function (key) {
        if (!this.decodeKey)
            return key.slice(this[exports.NAMESPACE].length);
